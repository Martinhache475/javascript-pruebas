...
document.write(todalafrase);

let frase = "  " +  "Javascript " + "es un lenguaje" + " esencial para crear" + " Sitios de Web poderosos.";
let completa = "El diablo" + " primero creo el infierno" + " y despues" + " creo los lenguajes de programacion. ";
document.write(frase + completa); console.log(frase + completa);
...
let edad;
edad = prompt("Si eres hombre Introduce tu edad");
if (edad >= 18){
